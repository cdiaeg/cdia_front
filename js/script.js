...
var sliderImages = Array.from(
  document.querySelectorAll(".home .homeSection .content")
);
...
const url =
  "https://script.google.com/macros/s/AKfycbw_og_I7LxHX6DQyixHMSvUoCC9SByN-H0TTx394H9YXIHxHgZmhpAfEsmunZwslN5UQA/exec";
...
const clientSlider = [
  ...document.querySelectorAll(".our-clients .all-clients .box"),
];
...
document
  .getElementById("clientsIndicators")
  .appendChild(paginationCLentsElement);
const paginationClientsdUl = document.getElementById("pagination-Clients-ul");
const paginatioClientsnBullets = [
  ...document.querySelectorAll("#pagination-Clients-ul li"),
];
...
function theClientsChecker() {
  ...
  paginationClientsdUl.children[currentClientsSlide - 1].classList.add(
    "active"
  );
...
function removeAllActivesFromClients() {
  ...
  paginatioClientsnBullets.forEach((bullet) =>
    bullet.classList.remove("active")
  );
}
